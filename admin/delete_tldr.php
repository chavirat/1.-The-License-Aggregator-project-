...
//query delete in tldr_license table
$delete_tldr = "DELETE FROM tldr_license WHERE tldr_key ='$key' ";

$result_delete_tldr = mysqli_query($con,$delete_tldr);
//check query
 if(! $result_delete_tldr) {
     echo
     "<form action='admin.php' method='post'>".
     "<input type='hidden' name='username' value ='admin'>".
     "<input type='hidden' name='password' value='password'>".
     "<input class='btn btn-danger' type='submit' value ='Back'></form>";
 		die("<div class='alert alert-danger'><strong>Error : </strong> Could not delete data into tldr_license:</div>" . mysql_error());
  }
  else{
    echo
    "<form action='admin.php' method='post'>".
    ...
    $key." already deleted into tldr_license table."."</div>";
  }
 mysqli_close($con);
  ?>
</body>

...
//query delete in nexb_requirements table
$delete_nexb_ob = "DELETE FROM nexb_requirements WHERE requirements ='$code' ";

$result_delete_nexb_ob = mysqli_query($con,$delete_nexb_ob);
//check query
 if(! $result_delete_nexb_ob) {
     echo
     "<form action='admin.php' method='post'>".
     "<input type='hidden' name='username' value ='admin'>".
     "<input type='hidden' name='password' value='password'>".
     "<input class='btn btn-danger' type='submit' value ='Back'></form>";
 		die("<div class='alert alert-danger'><strong>Error : </strong> Could not delete data into nexb_requirements:</div>" . mysql_error());
  }
  else{
    echo
    "<form action='admin.php' method='post'>".
    ...
    $code." </strong> already deleted into nexb_requirements table."."</div>";
  }
 mysqli_close($con);
  ?>
</body>

...
//query delete in nexb_license table
$delete_nexb = "DELETE FROM nexb_license WHERE nexb_key ='$key' ";

$result_delete_nexb = mysqli_query($con,$delete_nexb);
//check query
 if(! $result_delete_nexb) {
     echo
     "<form action='admin.php' method='post'>".
     "<input type='hidden' name='username' value ='admin'>".
     "<input type='hidden' name='password' value='password'>".
     "<input class='btn btn-danger' type='submit' value ='Back'></form>";
 		die("<div class='alert alert-danger'><strong>Error : </strong> Could not delete data into nexb_license:</div>" . mysql_error());
  }
  else{
    echo
    "<form action='admin.php' method='post'>".
    ...
    $key." already deleted into nexb_license table."."</div>";
  }
 mysqli_close($con);
  ?>
</body>
